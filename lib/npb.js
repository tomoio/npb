...
(function() {
  var NPB, async, beautifyjs, fs, hbs, path, touch, v, _ref;

  _ref = (function() {
    var _i, _len, _ref, _results;
    _ref = ['async', 'path', 'fs', 'beautifyjs', 'touch', 'handlebars'];
    _results = [];
    ...
    return _results;
  })(), async = _ref[0], path = _ref[1], fs = _ref[2], beautifyjs = _ref[3], touch = _ref[4], hbs = _ref[5];
