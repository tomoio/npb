...
(function() {
  ...
  module.exports = NPB = (function() {
    ...
    function NPB(root, opts, callback) {
      var config, k, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      this.root = root != null ? root : process.cwd();
      this.opts = opts != null ? opts : {};
      this.callback = callback != null ? callback : null;
      if (this.opts.configFile != null) {
      ...
      this.projectTitle = (_ref2 = this.opts.projectTitle) != null ? _ref2 : this.basename;
      this.description = (_ref3 = this.opts.description) != null ? _ref3 : 'A node module.';
      this.version = (_ref4 = this.opts.version) != null ? _ref4 : '0.0.1';
    ...
    NPB.prototype.readConfigFile = function() {
      try {
        console.log(path.resolve(this.opts.configFile));
        return JSON.parse(fs.readFileSync(path.resolve(this.opts.configFile), 'utf8'));
      } catch (e) {
        return false;
      }
    };
